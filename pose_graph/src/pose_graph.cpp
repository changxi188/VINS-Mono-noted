...
void PoseGraph::savePoseGraph()
{
    ...
    TicToc tmp_t;
    FILE*  pFile;
    LOG(INFO) << "savePoseGraph --- pose graph path: ", POSE_GRAPH_SAVE_PATH.c_str();
    LOG(INFO) << "savePoseGraph --- pose graph saving... ";
    ...
    LOG(INFO) << "savePoseGraph --- save pose graph time: " << tmp_t.toc() / 1000 << " s";
    m_keyframelist.unlock();
}
